...
public class DataSet {
    ...
    public static Object dataset(){
        // currently Data set contain only for two user but One can add as many as you
        // want
        // need to update email only for every run for every user

        Object[][] obj = {
                { "shahrukhkhan@gmalla.com", "shahrukh", "Khan", "testpass123@", "12", "7", "2000", "AdventureSports",
    ...
    // need to be update email only for every run for every run
        ...
        public static Object emailset(){
            Object[][] obj = {
                    { "shahrukhkhan@gmalla.com", "testpass123@", "Call before knock the door" },
